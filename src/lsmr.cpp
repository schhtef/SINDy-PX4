...
std::string
lsmr::GetStoppingReasonMessage() const
{
  std::string msg;
  switch( this->istop )
    {
...
unsigned int
lsmr::GetNumberOfIterationsPerformed() const
{
  return this->itn;
}
...
double
lsmr::GetFrobeniusNormEstimateOfAbar() const
{
  return this->normA;
}
...
double
lsmr::GetConditionNumberEstimateOfAbar() const
{
  return this->condA;
}
...
double
lsmr::GetFinalEstimateOfNormRbar() const
{
  return this->normr;
}
...
double
lsmr::GetFinalEstimateOfNormOfResiduals() const
{
  return this->normAr;
}
...
double
lsmr::GetFinalEstimateOfNormOfX() const
{
  return this->normx;
}
...
void
lsmr::SetLocalSize( unsigned int n )
{
  this->localSize = n;
}
...
void
lsmr::SetToleranceA( double value )
{
  this->atol = value;
}
...
void
lsmr::SetToleranceB( double value )
{
  this->btol = value;
}
...
void
lsmr::SetMaximumNumberOfIterations( unsigned int value )
{
  this->itnlim = value;
}
...
void
lsmr::SetUpperLimitOnConditional( double value )
{
  this->conlim = value;
}
...
void
lsmr::SetOutputStream( std::ostream & os )
{
  this->nout = &os;
}
 ...
 */
double
lsmr::D2Norm( double a, double b ) const
{
...
void
lsmr::Scale( unsigned int n, double factor, double *x ) const
{
  double * xend = x + n;
  while( x != xend )
    {
...
double
lsmr::Dnrm2( unsigned int n, const double *x ) const
{
